...
struct {
  ...
  {"PROGRAM", KW_PROGRAM}, // keyword PROGRAM
  {"CONST", KW_CONST},  // keyword CONST
  {"TYPE", KW_TYPE},  // keyword TYPE
  {"VAR", KW_VAR}, // keyword VAR
  {"INTEGER", KW_INTEGER}, // keyword INTEGER
  {"CHAR", KW_CHAR},
  {"ARRAY", KW_ARRAY},
  {"OF", KW_OF},
...
// so sanh hai chuoi ky tu khong phan biet hoa thuong
...
// kiem tra xem chuoi ky tu co phai la keyword khong
...
// chuyen doi mot TokenType thanh chuoi ky tu
